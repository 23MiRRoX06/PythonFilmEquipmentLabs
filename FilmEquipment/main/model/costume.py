...
class Costume(AbstractShootingEquipment):
    def __init__(self, year_of_use=1712, category="Christmas", size_eur="M", fabric_quality=Quality.MIDDLE,
                 components="Pants and shirt", production_year=2010,
                 warranty_work_period_in_months=12, factory_manufacturer="personage.ua", country_manufacturer="Ukraine",
                 model_name="Santa", material="fabric",
                 weight_in_grams=7000, color="red"):
